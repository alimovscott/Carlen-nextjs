	...
	const data: any = {
		product: [
			...
			},
			{
				...
				content: 'Simply use our search bar to enter location, price range, seatsrooms/bathrooms, and product type.',
			},
			{
		...
		payment: [
			...
			},
			{
				...
				content: 'No, our services are free for buyers. Sellers pay a commission upon successful manual.',
			},
			{
		...
		buyers: [
			{
				...
				content: 'Buyers should check and decide whether the product they want to buy or automatic is actually suitable!',
			},
			{
			...
			},
			{
				...
				content:
					'Yes, you can negotiate the price of a product. Our agents will assist you in making competitive offers and negotiating terms with the seller.',
			},
			{

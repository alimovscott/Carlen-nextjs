Go outside of this project and read carlen/docs/ai first!

# Carlen Frontend Modification Instructions

This client project is being migrated from nestar-next to carlen-next
...
- docs/ai/FRONTEND_MIGRATION.md
  and etc inside of carlen/docs/ai
...
6. Update carlen/docs/ai/COMPLETED_TASKS.md after major changes.
